	...
	<div class="wrapper">
		...
		<nav class="main-header navbar navbar-expand navbar-white navbar-light">
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block">
					<a href="<?php echo base_url(); ?>index.php/Usuarios/logout" class="nav-link">Salir</a>
				</li>
			</ul>
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="../../index3.html" class="brand-link">
				<img src="<?php echo base_url(); ?>admilte/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
				<span class="brand-text font-weight-light">F i p a g o</span>
			</a>
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-3 pb-3 mb-3 d-flex">
					...
					<div class="info">
						<a href="#" class="d-block">Gabriel Vela</a>
					</div>
				</div>
               ...
               with font-awesome or any other icon font library -->
						...
						<li class="nav-item menu-open">
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item">
									<a href="<?php echo base_url(); ?>index.php/Conductor/agregar" class="nav-link ">
										<i class="far fa-circle nav-icon"></i>
										<p>Registrar</p>
									</a>
								</li>
								<li class="nav-item">
									<a href="<?php echo base_url(); ?>index.php/Conductor/deshabilitados" class="nav-link">
										<i class="far fa-circle nav-icon"></i>
										<p>Inahabilitados</p>
									</a>
								</li>
